...
Criamos uma conta no site do Git hub e configuramos o ssh no git bash, verificamos se existe uma chave, adicionamos uma nova chave, com: 
ssh-keygen -t ed25519 -C” seu emailexemple.com “
 iniciamos agente-ssh:
 eval “$(ssh-agent -s)”
 adicionamos uma chave ao ssh ao agente:
 ssh-add ~/.ssh/id_ed25519
 copiamos a chave shh e adicionamos no git hub e testamos conexão, criamos e clonamos um repositório no git hub e instalamos o vscode
